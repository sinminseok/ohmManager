...
class _GymRegisterView2 extends State<GymRegisterView2> {
              ...
              children: [
                Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("월요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_mondaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${monday_start}",
                                    style: TextStyle(
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_mondayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${monday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("화요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_tusdaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${tuesday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_tuesdayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${tuesday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("수요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_wednesdaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${wednesday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_wednesdayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${wednesday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("목요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_thursdaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${thursday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_thursdayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${thursday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("금요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_fridaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${friday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_fridayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${friday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                widget.closedday == "토요일" ? Container() : Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("토요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_staurdaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${saturday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_staurdayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${saturday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                widget.closedday == "일요일" ? Container() : Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("일요일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_sundaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${sunday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_sundayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${sunday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
                ...
                widget.holyday_bool == true ? Container() : Container(
                    ...
                    child: InkWell(
                        ...
                        child: Text("공휴일 운영 시간", style: TextStyle(
                            fontSize: 20,
                            fontWeight: FontWeight.bold,
                            color: kTextColor),))),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_holydaystart(
                                      size, context, "title");
                                },
                                child: Text("시작 시간 : ${holiday_start}",
                                    style: TextStyle(
                                        fontSize: 20, color: kTextColor))),
                          ),
                          Container(
                            ...
                            child: InkWell(
                                onTap: () {
                                  showDialog_holydayend(
                                      size, context, "title");
                                },
                                child: Text("종료 시간 : ${holiday_end}",
                                  style: TextStyle(
                                      fontSize: 20, color: kTextColor),)),
                          ),
                        ],
  ...
  void showDialog_wednesdaystart(Size size, BuildContext context,
      String title) {
    showGeneralDialog(
        context: context,
        barrierDismissible: true,
